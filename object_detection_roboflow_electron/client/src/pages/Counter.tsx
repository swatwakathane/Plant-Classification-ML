      ...
      if (canvasRef.current && imageElement) {
        ...
        if (ctx) {
          for (let i = 0; i < predictions.length; i++) {
            ...
            ctx.lineWidth = 5;
            ctx.strokeRect(prediction.x -120, prediction.y -50, prediction.width, prediction.height);
            ctx.fillStyle = 'red';
            ctx.font = '30px Arial';
            ctx.fillText(`${prediction.class} (${prediction.confidence.toPrecision(2)})`, prediction.x -120, prediction.y -55);
  ...
  return (
    <Layout>
      ...
      >
        ...
        <main
          className='w-10/12  max-w-[400px] bg-gray-900 border border-slate-700 rounded-lg shadow-2xl p-8'
        >
          <input
            type="file"
              ...
              imageString ?
                <>
                  ...
                  >
                    ...
                    <p
                      className='text-white text-lg pr-2 w-100'
                    >
                      plant :
                    </p>
                    ...
                    <button
                      ...
                      disabled={loading}
                      className='bg-red-600 ml-auto w-max shrink-0 text-white px-4 py-2 rounded-full'
                    >
                      {
